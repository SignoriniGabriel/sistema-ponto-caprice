{{--<x-guest-layout>--}}
{{--<div class="flex md:flex-row flex-col-reverse md:items-stretch items-center justify-center mt-12">--}}
...
{{--            <h1 class="md:text-5xl text-3xl font-bold text-center text-gray-800">Wild Goose Chase</h1>--}}
{{--            <p class="sm:w-96 w-full mt-6 text-base leading-6 text-center text-gray-600">A phrase is a short selection of words which when put together create a concept.</p>--}}
...
{{--                    </svg>--}}
{{--                </div>--}}
{{--                <p class="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">A phrase is a short selection of words which when put together create a concept. There are eight types of phrases.</p>--}}
{{--            </div>--}}
...
{{--                    </svg>--}}
{{--                </div>--}}
{{--                <p class="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">A phrase is a short selection of words which when put together create a concept.</p>--}}
{{--            </div>--}}
{{--            <div class="mt-7 flex flex-col items-center">--}}
{{--                <div class="w-20 h-20 bg-white shadow rounded-full flex items-center justify-center" role="img" aria-label="ideas">--}}
...
{{--                    </svg>--}}
{{--                </div>--}}
{{--                <p class="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">Whether article spirits new her covered hastily sitting her. Money witty</p>--}}
{{--            </div>--}}
{{--            <div class="mt-7 flex flex-col items-center">--}}
{{--                <div class="w-20 h-20 bg-white shadow rounded-full flex items-center justify-center" role="img" aria-label="bright ideas">--}}
{{--                    <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
...
{{--        <img src="{{url('storage/assets/Geral/atelier.png')}}" class="h-full rounded-md object-cover object-center md:block hidden">--}}
{{--        <img src="https://i.ibb.co/7SmJNvH/about-image.png" alt="image ow a woman studying" class="h-full rounded-md object-cover object-center md:block hidden" />--}}
{{--    </div>--}}
{{--</div>--}}
{{--</x-guest-layout>--}}
