        ...
        <div class="md:grid md:grid-cols-2 md:gap-6">
            <div class="mt-5 md:mt-0 md:col-span-12">
                <form method="POST" action="{{ route('categories.update', $category->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <h3 class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">{{__('Edit Category')}}</h3>
                        ...
                        <div class="px-4 py-5 bg-white dark:bg-gray-800 sm:p-6">
                            <div class="grid grid-cols-6 gap-10">
                                ...
                                <div class="col-span-12">
                                    ...
                                    <input id="name" type="text" name="name" value="{{$category->name}}" required class="block w-full mt-1 text-sm dark:border-gray-700 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                                </div>
