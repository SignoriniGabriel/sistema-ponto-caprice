    ...
    <aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
        <div class="py-4 text-gray-500 dark:text-gray-400">
            <a class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200" href="{{ route('dashboard') }}">
                <img src="{{url('storage/assets/logo/PC.png')}}">
            </a>
            <!-- Search input -->
            <div class="flex justify-center px-6 mt-12">
                ...
                <ul class="mt-6">
                  ...
                  <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                        <div class="flex items-center px-2 py-3 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700">
                ...
                <!-- Profile menu -->
                <div class="flex relative align-baseline">
