...
<head>
    ...
    <body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
        ...
        <nav id="header" class="fixed w-full z-30 top-0 text-white sticky-header">
...
{{--                        </li>--}}
    ...
    <div class="flex-1 h-full max-w-7xl mx-auto overflow-hidden  dark:bg-gray-800">
        <div class="flex flex-col overflow-y-auto md:flex-row">
            <div class="flex p-6 sm:p-12 md:w-1/2 border-r dark:border-gray-600">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <label class="">
                            ...
                            <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                   id="email" type="email" name="email"  placeholder="" required autofocus/>
                        </label>
                        <!-- Password -->
                        <label class="block mt-6 text-sm">
                            <span class="text-gray-700 dark:text-gray-400 text-login">Your password</span>
                            <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
...
{{--                        <a class="text-sm text-gray-500 hover:underline mt-4"  href="{{ route('password.request') }}">--}}
...
{{--                            </div>--}}
    ...
    <footer class="items-center justify-center">
        <hr class="mx-auto container bg-gray-200" />
