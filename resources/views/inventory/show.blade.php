            ...
            <div class="w-full flex items-center justify-center">
                <div class="flex flex-col items-center">
                    <div tabindex="0" class="focus:outline-none h-32 w-32 lg:mb-0">
                        <img src="{{url('storage/products/'.$product->image)}}" alt="man avatar" class="h-full w-full rounded-full overflow-hidden bg-white shadow" />
                    </div>
                    <p tabindex="0" class="focus:outline-none mt-3 text-xl md:text-base font-semibold text-center text-white">{{$product->name}}</p>
                </div>
            </div>
            <div class="flex items-center mt-7">
                <div class="">
                    <p tabindex="0" class="focus:outline-none text-xs text-gray-300">Product SKU</p>
                    <p tabindex="0" class="focus:outline-none mt-2 text-base sm:text-lg md:text-xl 2xl:text-2xl text-gray-50 text-center">{{$product->id}}</p>
                </div>
                <div class="ml-12">
                    <p tabindex="0" class="focus:outline-none text-xs text-gray-300">Current Inventory</p>
                    <p tabindex="0" class="focus:outline-none mt-2 text-base sm:text-lg md:text-xl 2xl:text-2xl text-gray-50 text-center">{{$inventory->amount}}</p>
                </div>
{{--                <div class="ml-12">--}}
